...
from myapp.views import home, components_alerts,dashboard,components_accordion, components_badges, components_breadcrumbs,components_buttons, components_cards, components_carousel, components_list_group, components_modal, components_tabs, components_pagination, components_progress, components_spinners, components_tooltips, users_profile, pages_faq, pages_contact, pages_register, pages_login, pages_error_404, pages_blank, forms_elements, forms_layouts, forms_editors, forms_validation, icons_bootstrap, icons_remix, icons_boxicons,charts_chartjs, charts_apexcharts, charts_echarts,tables_general, tables_data
urlpatterns = [
    path('', home, name='home'),
